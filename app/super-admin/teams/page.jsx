...
const SuperAdminTeams = () => {
  return (<div className="space-y-6">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
      {resolvedTeams.map((team) => (<div key={team.id} className="bg-card rounded-xl border p-6">
