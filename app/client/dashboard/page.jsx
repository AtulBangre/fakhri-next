          ...
          <div className="p-4 border-t border-sidebar-border">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate">{session?.user?.name || "Client User"}</p>
                <p className="text-xs text-sidebar-foreground/70 truncate">{session?.user?.planName || "Free Plan"}</p>
              </div>
            </div>
            <Button
              variant="outline"
