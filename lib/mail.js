...
export const emailTemplates = {
    ...
    welcomeClient: (data) => ({
        subject: `Welcome to Fakhri IT Services, ${data.name}!`,
        html: `
            <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 0; border: 1px solid #e0e0e0; border-radius: 12px; overflow: hidden; background-color: #ffffff;">
                ...
                <div style="padding: 40px 30px; text-align: center;">
                    ...
                    <p style="color: #555; line-height: 1.6; margin-bottom: 25px;">
                        We are thrilled to have you join Fakhri IT Services. You've taken the first step towards transforming your digital presence with our premium IT solutions.
                    </p>
                    ...
                    <a href="${data.dashboardUrl}" style="display: inline-block; padding: 14px 28px; background-color: #880808; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px;">Go to Dashboard</a>
                </div>
